...
import { bindStore, saveGroup, fetchCachedGroupMetadata } from '#lib/store';
import { handleGroupParticipantsUpdate } from '#helper/groupParticipantsHandler';
...
export async function connectToWhatsApp(onMessage) {
    ...
    const sock = makeWASocket.default ? makeWASocket.default({
        ...
        cachedGroupMetadata: fetchCachedGroupMetadata,
    }) : makeWASocket({
        version,
        auth: state,
        printQRInTerminal: false,
